    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <div class="p-4 space-y-4 border-b border-outline-variant/10">
        ...
        <div class="flex flex-wrap gap-2 pt-2">
          ...
          <a v-if="leadData?.tiktokUrl" :href="leadData.tiktokUrl" target="_blank"
             class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-black/10 text-black hover:bg-black/20 transition-all">
...
const noteTypeIcon = (type) => {
  const map = { whatsapp: 'chat', telepon: 'call', visit: 'location_on', email: 'mail', facebook: 'thumb_up', instagram: 'photo_camera', tiktok: 'music_note', catatan: 'note' }
